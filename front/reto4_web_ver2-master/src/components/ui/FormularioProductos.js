...
const FormularioProductos = ({producto}) => {
    ...
    fetch("http://localhost:81/api/cookware/all")
    .then((res) => res.json())
    .then((data) => {
        //console.log(data);
...
const actualizarProducto = reference =>{
    ...
    return( 
        ...
        <div className="w-full px-3 mb-4">
            <div className="p-5 shadow-md bg-gray">
                <div className="lg:flex">
                    <div className="lg:w-5/12 xl:w-3/12">
                      ...
                      <img src={photography} alt=" imagen producto " />
                            ...
                            <p className="font-bold text-2xl text-purple-600 mb-4">{brand} </p>
                            <p className="font-bold text-2xl text-purple-600 mb-4">{reference} </p>
                        ...
                        <button
                            ...
                            type="submit"
                            className="bg-purple-800 hover:bg-yellow-900 w-full mt-5 p-2 text-white uppercase font-bold"
                           > 
                           Borrar
                           
                           </button>
                          
                            <Link to={`/actualizar-producto/${producto.reference}`} className="  bg-purple-800 hover:bg-yellow-700, w-full inline-block mt-5 p-2 text-white uppercase font-bold text-center">
                                Actualizar Producto
                            </Link>
